...
const nodes = ['232 Hillwood Blvd, Nashville, TN 37205', '224 W Hillwood Dr, Nashville, TN 37205', '215 Hillwood Blvd, Nashville, TN 37205', '913 Neartop Dr, Nashville, TN 37205',
'224 Wilsonia Ave, Nashville, TN 37205', '305 Hillwood Blvd, Nashville, TN 37205', '400 Wilsonia Ave, Nashville, TN 37205'];
const options = {
...
var costMatrix = new Array(nodes.length);
//var nodes = locations;
...
function run(){
    ...
    const data  = GoogleDistanceApi.distance(options, (err, data) => {
        ...
        var tmp = new Array(nodes.length);
        ...
        var cyclesMatrix = Array(cycles.length);
        for (var i = 0; i < cycles.length; i++){
            cycles[i].logCycle();
            cyclesMatrix[i] = cycles[i].toArray();
...
// var nodes = ['232 Hillwood Blvd, Nashville, TN 37205', '224 W Hillwood Dr, Nashville, TN 37205', '215 Hillwood Blvd, Nashville, TN 37205', '913 Neartop Dr, Nashville, TN 37205',
// '224 Wilsonia Ave, Nashville, TN 37205', '305 Hillwood Blvd, Nashville, TN 37205', '400 Wilsonia Ave, Nashville, TN 37205'];
...
function exp(cyclesMatrix){
  app.get('/', (req, res) => {
    res.write("hello there");
    console.log("helo");
    
    //res.status(200).send('<h1>HELLO THERE</h1>');
    //res.json(cyclesMatrix);

    for (var i = 0; i < cyclesMatrix.length; i++){
      res.write("\n");
      res.write("cycle: \t");
      res.write(cyclesMatrix[i].join("->"));
    }
